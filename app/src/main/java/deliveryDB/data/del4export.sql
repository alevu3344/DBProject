...
--
-- Host: localhost
-- Creato il: Lug 15, 2024 alle 15:35
...
CREATE TABLE `ORDINI` (
  ...
  `RistoranteID` int(11) NOT NULL,
  `Commissione` DECIMAL(5,2) NOT NULL DEFAULT 0.00
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(38, '2024-07-14 20:13:21', 'elisa.gatti', 12);
...
('elisa.gatti', 'Elisa', 'Gatti', 'gatti567', 'Via Garibaldi', '9', 'Roma', 'Consumatore', 19712.50),
...
--
ALTER TABLE `ORDINI`
  MODIFY `OrdineID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
