...
public class PreviewPage {
    ...
    private Optional<PreviewsController> controller;

    public PreviewPage(JFrame mainFrame) {
        this.controller = Optional.empty();
        this.mainFrame = mainFrame;

    }

    public void setController(PreviewsController ctrl) {
        this.controller = Optional.of(ctrl);
    }

    private PreviewsController getController() {
