...
/*Backup of  preview page in java fx */
...
public final class Previews {
    ...
    public Previews(Stage primaryStage){
        ...
        primaryStage.setScene(new Scene(new VBox(), 300, 100));
        primaryStage.show();
    ...
    private Controller getController() {
        return controller.orElseThrow(() -> new IllegalStateException(
            "The Previews's Controller is undefined. Did you remember to call " +
            "setController before starting the application? Remember that " +
            "Previews needs a reference to the controller in order to notify it " +
